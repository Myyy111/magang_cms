        ...
        <div class="col-12 col-lg-8">
            <div class="card shadow border-0" style="border-radius: 12px;">
                ...
                <div class="card-body px-4 pb-4">
                    ...
                    <div class="form-group">
                        <label for="icon" class="font-weight-600">{{ __('dashboard.icon') }} <span class="text-muted" style="font-size: 11px;">(Font Awesome Icon, e.g. &lt;i class="fas fa-cog"&gt;&lt;/i&gt;)</span></label>
                        <input type="text" class="form-control" name="icon" id="icon" value="{{ old('icon') }}" placeholder='<i class="fas fa-cog"></i>'>
                    </div>
