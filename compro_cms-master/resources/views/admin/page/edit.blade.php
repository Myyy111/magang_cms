        ...
        <div class="col-12 col-lg-9">
            <div class="card shadow border-0" style="border-radius: 12px;">
                ...
                <div class="card-body px-4 pb-4">
                    ...
                    <div class="form-group">
                        <label for="image" class="font-weight-600">{{ __('dashboard.thumbnail') }} <span class="text-muted" style="font-size: 11px;">( {{ __('dashboard.image_size', ['height' => 500, 'width' => 800]) }} )</span></label>
                        
                        @if(file_exists(public_path('uploads/'.$path.'/'.$row->image_path)))
                        <div class="mb-2">
                             <img src="{{ asset('uploads/'.$path.'/'.$row->image_path) }}" class="img-fluid rounded border" alt="Page" style="max-height: 200px;">
                        </div>
                        @endif
