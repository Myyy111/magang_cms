            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <select class="form-control" name="kategori">
                        <option value="direksi" {{ $row->kategori == 'direksi' ? 'selected' : '' }}>Direksi</option>
                        <option value="komisaris" {{ $row->kategori == 'komisaris' ? 'selected' : '' }}>Komisaris</option>
                        <option value="head_unit" {{ $row->kategori == 'head_unit' ? 'selected' : '' }}>Head Unit</option>
                    </select>



                    <div class="form-group">
                        <label for="career_history">Riwayat Pekerjaan (Gunakan Enter untuk baris baru)</label>
                        <textarea class="form-control" name="career_history" id="career_history" rows="4">{{ $row->career_history }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="education_history">Riwayat Pendidikan (Gunakan Enter untuk baris baru)</label>
                        <textarea class="form-control" name="education_history" id="education_history" rows="4">{{ $row->education_history }}</textarea>
                    </div>
