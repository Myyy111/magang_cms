        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="kategori">Kategori Tim</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="career_history" id="career_history" rows="4">{{ old('career_history') }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="education_history">Riwayat Pendidikan (Gunakan Enter untuk baris baru)</label>
                        <textarea class="form-control" name="education_history" id="education_history" rows="4">{{ old('education_history') }}</textarea>
                    </div>
