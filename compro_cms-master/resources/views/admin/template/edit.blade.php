            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control summernote" name="description" id="description" rows="12">{!! $row->description !!}</textarea>
                        
                        <div class="mt-2 text-muted small">
                            <strong>{{ __('dashboard.codes_description') }}:</strong><br>
                            @if($row->slug == 'contact-us')
                            @include('admin.template.codes.contact')
                            @elseif($row->slug == 'get-quote')
                            @include('admin.template.codes.quote')
                            @endif
                        </div>
                    </div>
