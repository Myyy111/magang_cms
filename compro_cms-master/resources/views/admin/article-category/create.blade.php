            ...
            <div class="card shadow border-0" style="border-radius: 12px;">
                ...
                <div class="card-body px-4 pb-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="title" value="{{ old('title') }}" required placeholder="Contoh: Teknologi, Bisnis, dsb.">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="description" id="description" rows="4" placeholder="Deskripsi singkat kategori">{{ old('description') }}</textarea>
                    </div>
                    <!-- Form End -->
