            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="wc_product_id" id="wc_product_id" value="{{ $row->wc_product_id }}">
                        <small class="form-text text-muted">ID Produk di WooCommerce (misal: 871).</small>
                    </div>

                    <div class="form-group">
                        <label for="sku">SKU</label>
                        <input type="text" class="form-control" name="sku" id="sku" value="{{ $row->sku }}">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="image">{{ __('dashboard.thumbnail') }} <span>{{ __('dashboard.image_size', ['height' => 800, 'width' => 800]) }}</span></label>
