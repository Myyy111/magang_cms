            ...
            <div class="card shadow border-0" style="border-radius: 12px;">
                ...
                <div class="card-body px-4 pb-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="title" value="{{ old('title') }}" required placeholder="Masukkan judul slider">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control textMediaEditor" name="description" id="description" rows="8">{{ old('description') }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="image" class="font-weight-600">{{ __('dashboard.thumbnail') }} <span class="text-danger">*</span> <span class="text-muted" style="font-size: 11px;">( {{ __('dashboard.image_size', ['height' => 800, 'width' => 1920]) }} )</span></label>
