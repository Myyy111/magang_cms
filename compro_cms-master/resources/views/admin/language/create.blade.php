            ...
            <div class="card shadow border-0" style="border-radius: 12px;">
                ...
                <div class="card-body px-4 pb-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="name" value="{{ old('name') }}" required placeholder="Contoh: Indonesia, English, dsb.">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="code" id="code" value="{{ old('code') }}" required placeholder="en">
