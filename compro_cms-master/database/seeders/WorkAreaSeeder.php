    ...
    public function run()
    {
        ...
        $data = [
            ...
            [
                'wilayah_kerja' => 'kantor_wilayah',
                'kab_kota' => 'Bandung',
                'kantor_wilayah_label' => 'Kedeputian Wilayah IV (Jawa Barat)',
                'kantor_cabang' => 'Kedeputian Wilayah IV',
        ...
        foreach ($data as $item) {
            // Remove helper keys if they exist from AI hallucination
            if(isset($item['kantor_wilayah_label'])) unset($item['kantor_wilayah_label']);
