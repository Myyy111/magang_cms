    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('image')){
            ...
            if (extension_loaded('gd') || extension_loaded('imagick')) {
                Image::make($request->file('image')->getRealPath())->fit(400, 500, function ($constraint) { $constraint->upsize(); })->save($thumbnailpath);
            } else {
        ...
        $member->career_history = $request->career_history;
        $member->education_history = $request->education_history;
        ...
        $member->kategori = $request->kategori;
        $member->save();
